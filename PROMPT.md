...
## Input: <icon name, category name, or custom instructions>
- Example: `joystick, gaming, joystick-gamepad, add 10 icons to every category`
- When generating without a specific icon name, ensure you are not duplicating existing icons

## Generate animated SVG emoji icons in the "flat material" style. 
- Extend generation of @icons/. Reference both the existing icons as samples, and the following prompt for continued, accurate generation
...
## Once generated
1. Save each SVG to `icons/` folder
2. Update meta data on README.me
